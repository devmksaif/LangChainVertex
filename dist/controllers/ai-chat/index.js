...
async function aiChat(req, res) {
    ...
    try {
        ...
        // Define tools
        const buildWorkflowTool = (0, tools_1.tool)(async ({ description }) => {
            try {
        ...
        const editWorkflowTool = (0, tools_1.tool)(async ({ instructions }) => {
            try {
        ...
        if (provider === "juliabot") {
            ...
            langchainMessages.unshift(new messages_1.SystemMessage(systemPrompt));
